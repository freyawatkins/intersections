...
open %>% ggplot(aes(x=Group, y=value/100, fill = openness)) +
  ...
  coord_flip() +
  labs(title = "Figure 0. Openness about Sexual Orientation, Gender Identity & Expression, Sex Characteristics",
...
ggsave(here::here("figures", "fig0.png"), plot = last_plot(), 
...
endsmeet %>% filter(Response != "Dont know" & Response != "Prefer not to say") %>%
  ...
  scale_y_continuous(labels = percent_format(accuracy=1)) +
  coord_flip() +
  labs(title = "Figure 1. Household ability to make ends meet, disaggregated",
       x = NULL, y = NULL, fill = NULL,
...
notreport %>%
  ...
  coord_flip() +
  facet_wrap(~Response) +
  labs(title = "Figure 2. Reasons why discrimination was not reported, disaggregated",
       x = NULL, y = NULL, fill = NULL,
...
healthdiscrim %>%
  ...
  coord_flip() +
  facet_wrap(~Response) +
  labs(title = "Figure 3. Experiences of specific barriers in access to healthcare, disaggregated",
       x = NULL, y = NULL, fill = NULL,
...
#            position = position_stack(vjust = 0.5, reverse = F )) +
  ...
  scale_y_continuous(labels = percent_format(accuracy=1)) +
  coord_flip() +
  labs(title = "Figure 4. Number of times physically or sexually attacked in the last 5 years, disaggregated",
       x = NULL, y = NULL, fill = NULL,
...
ggplot(aes(x=Group, y=value/100, fill = Response)) +
  ...
  scale_y_continuous(labels = percent_format(accuracy=1)) +
  coord_flip() +
  labs(title = "Figure 5. Experiences of some kind of harassment in the last 5 years, disaggregated",
       x = NULL, y = NULL, fill = NULL,
...
age %>%
  ...
  scale_y_continuous(labels = percent_format(accuracy=1)) +
  coord_flip() +
  labs(title = "Figure 6. Age at which respondents realised that they were trans or non-binary",
       x = NULL, y = NULL, fill = NULL,
...
ggsave(here::here("figures", "fig6a.png"), plot = last_plot(), 
...
age2 %>%
  ...
  scale_y_continuous(labels = percent_format(accuracy=1)) +
  coord_flip() +
  labs(title = "Figure 6. Age at which trans & non-binary respondents realised that they were trans or non-binary",
       x = NULL, y = NULL, fill = NULL,
...
ggsave(here::here("figures", "fig6b.png"), plot = last_plot(), 
...
intervention %>% filter(Response != "Not needed" & Response != "Don’t know where to go" &
  ...
  labs(title = "Figure 7. Reasons for not undergoing medical interventions, disaggregated",
       x = NULL, y = NULL, fill = NULL,
...
ggsave(here::here("figures", "fig7.png"), plot = last_plot(), 
       width = 12, height = 8, units = "in")
```
